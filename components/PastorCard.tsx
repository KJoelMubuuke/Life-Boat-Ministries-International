...
export default function PastorCard() {
  return (
    <div className="w-full max-w-[220px] md:max-w-[280px] bg-white/40 backdrop-blur-md border border-black/70 shadow-2xl rounded-2xl px-4 py-4 md:px-6 md:py-5 flex flex-col items-center text-center">
